...
<Callout type="info">You can also supply `image` and `slug` to the frontmatter.</Callout>
...
<Callout type="info">
  Capitalization does not matter for the image file, make it all lower-case.
</Callout>
