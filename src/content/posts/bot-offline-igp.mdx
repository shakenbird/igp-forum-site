...
<Callout type="error">
If you're here from this video, https://youtu.be/k5BspQ9Czek, please watch this instead and come back here after finishing it. https://youtu.be/Gqurhm2QxA0
</ Callout>
...
<Callout type="info">
  Make sure to reverse/undo any changes you did by yourself in the
  `package.json` file.
</Callout>
